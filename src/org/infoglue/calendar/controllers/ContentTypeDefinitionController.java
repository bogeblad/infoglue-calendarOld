...
public class ContentTypeDefinitionController
{
    ...
    {
    	ContentTypeDefinition contentTypeDefinition = (ContentTypeDefinition)EventTypeController.getController().getEventType(id, session);
    ...
    /*
    public ContentTypeDefinition create(ContentTypeDefinition contentTypeDefinition) throws ConstraintException, SystemException
    {
        ContentTypeDefinition contentTypeDefinition = new ContentTypeDefinitionImpl();
        contentTypeDefinition.setValueObject(contentTypeDefinition);
    ...
    */
    ...
    /*
    public void delete(Long id, Session session) throws ConstraintException, SystemException
    {
    	
    }
    */
    
    public void update(Long id, ContentTypeDefinition contentTypeDefinition, Session session) throws Exception
    {
...
*/
	...
	public String getAttributeValue(String attributes, String attributeName, boolean escapeHTML)
	{
		...
		if(startTagIndex > 0 && startTagIndex < xml.length() && endTagIndex > startTagIndex && endTagIndex <  xml.length())
		{
			...
			if(escapeHTML)
				value = new org.infoglue.common.util.VisualFormatter().escapeHTML(value);
		}		
